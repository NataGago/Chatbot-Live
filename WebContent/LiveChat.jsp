            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-footer">
                    <div id="actions" class="input-group">
                        <input id="btn-input" type="text" name="pergunta" id="pergunta"class="form-control input-sm" placeholder="Digite sua mensagem aqui..." />
                        <span class="input-group-btn">
                            <button type="submit" style="margin-left: 5px" class="btn btn-primary" name="command" value="PerguntarChat">Enviar</button>
                        </span>
                        <span class="input-group-btn">
                            <button type="submit" style="margin-left: 5px" class="btn btn-danger" name="command" value="FinalizarAtendimento">Finalizar</button>
                        </span>
                    </div>
                </div>
            	</form>
