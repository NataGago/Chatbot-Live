...
<body class="animsition">
    <div class="page-wrapper">
                ...
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <a class="logo" href="index.html">
                            <img src="images/icon/logo.png" alt="Cartorio" />
                        </a>
    	...
    	<aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="Home.jsp"><img src="images/icon/logo.png" alt="Cool Admin" /></a>
            </div>
                        	...
                        	<div class="noti-wrap">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Lukas Barbosa</a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#">Lukas Barbosa</a>
                                                    </h5>
                                                    <span class="email">lukasbarbosa@usjt.com</span>
                                                </div>
                                            </div>
