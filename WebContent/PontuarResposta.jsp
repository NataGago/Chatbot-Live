...
<head>
    ...
    <title>cartorio.biz - Pontuação</title>
    ...
    <div class="row">
        <div class="col-md-12 col-xl-">
            ...
            <div class="form-group col-md-12">
                ...
                <div class="col-md-12">
                    <button  type="submit" class="btn btn-primary" name="command" value="PontuarResposta">Sim</button>
                     <button type="submit" class="btn btn-primary" name="command" value="NegarResposta">Não</button>
                </div>
            </div>
                </div>
            	</form>
